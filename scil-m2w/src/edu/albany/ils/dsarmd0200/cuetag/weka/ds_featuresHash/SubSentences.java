...
//                System.out.println(subSentences.size());
...
//               System.out.println("1."+first.getTag()+"==="+subSentences);
                    return first;
	    }
...
//                 System.out.println("2."+last.getTag()+"==="+subSentences);
		return last;
	    }
...
//                 System.out.println("3."+second.getTag()+"==="+subSentences);
		return second;
	    }
            else{
//		            System.out.println("All assertion-opinion ?? " + first.getTag()+"==="+subSentences);
		return first;
            }
...
//               System.out.println("return 3:"+tmparr.getTag());
           ...
           tmparr=subSentences.get(i);
            if(!(tmparr.getTag().toLowerCase().trim().equals(DsarmdDATag.AS)) && (pre_utt!=null|pre_utt==null))
           {//return any other tag other than AS, if it exists
