...
public class DialogActArffGen {
     ...
     */
    public DialogActArffGen(ArrayList all_utts,
            ArrayList tr_utts,
            ArrayList utts){
        init();
    ...
    private void heading(ArrayList tr_utts){
        ...
        //System.out.println("Tags: " + Arrays.toString(tag_no_.keySet().toArray()));
    }
